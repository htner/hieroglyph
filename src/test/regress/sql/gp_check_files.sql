...
CREATE TABLESPACE checkfile_ts LOCATION '/home/gpadmin/sdb/src/test/regress/testtablespace';
...
\cd /home/gpadmin/sdb/src/test/regress/testtablespace
...
-- is number-named.
\! if pwd | grep -q "^/home/gpadmin/sdb/src/test/regress/testtablespace/.*$"; then find . -maxdepth 1 -type f -regex '.*\/[0-9]+' -exec rm {} \; -quit; fi
...
\! if pwd | grep -q "^/home/gpadmin/sdb/src/test/regress/testtablespace/.*$"; then find . -maxdepth 1 -type f -regex '.*\/[0-9]+\.1' -exec rm {} \; -quit; fi
\! if pwd | grep -q "^/home/gpadmin/sdb/src/test/regress/testtablespace/.*$"; then find . -maxdepth 1 -type f -regex '.*\/[0-9]+\.1' -exec rm {} \; -quit; fi
...
\! rm -rf /home/gpadmin/sdb/src/test/regress/testtablespace/*;
